...
const container = document.getElementById("contact-hero-webgl");

if (!container) {
    console.error("contact-hero-webgl container not found.");
} else {
    ...
    loader.load("assets/images/contacthero.webp",
        (t) => { colorTexture = t; tryBuild(); },
        undefined,
        (e) => console.error("Color load failed:", e)
    );

    loader.load("assets/images/contacthero-depth.png",
