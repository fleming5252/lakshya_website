...
const container = document.getElementById("projects-hero-webgl");

if (!container) {
    console.error("projects-hero-webgl container not found.");
} else {
    ...
    loader.load("assets/images/projectshero.webp",
        (t) => { colorTexture = t; tryBuild(); },
        undefined,
        (e) => console.error("Color load failed:", e)
    );

    loader.load("assets/images/projectshero-depth.png",
