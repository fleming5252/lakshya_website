...
const container = document.getElementById("services-hero-webgl");
...
if (!container) {
            ...
            fragmentShader: `
                ...
                void main() {
                    ...
                    if (ratio > 1.0) {
                        ...
                        uv.x = uv.x * ratio + (1.0 - ratio) * 0.8;   /* 0.0 = left-align, 1.0 = right-align, 0.5 = center */
                    }
    ...
    loader.load("assets/images/serviceshero.webp",
        (t) => { colorTexture = t; tryBuild(); },
        undefined,
        (e) => console.error("Color load failed:", e)
    );

    loader.load("assets/images/serviceshero-depth.png",
